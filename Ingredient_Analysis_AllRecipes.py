...
with open(folders[0] + '\\recipe_directory.txt','r',encoding='utf8') as f:
...
counter = 0
for i in index_list:
    path = os.getcwd() + '//Results_AllRecipes/' 
...
is_vanilla = [i for i, s in enumerate(mass_text) if "vanilla" in s]
...
with open('ingredient_measures_AllRecipes.csv','w') as csvfile:
...
for i in whole_list:
    ...
    with open('ingredient_measures_AllRecipes.csv','a') as csvfile:
        writer = csv.writer(csvfile)
